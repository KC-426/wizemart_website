          ...
          <div className="row">
            <div className="col-12 col-md-6 col-lg-4">
              <div className="footer__section -info">
                ...
                <img src={process.env.PUBLIC_URL + imageImport.logo} alt="Logo" width='74px' height='100%' />
                <p style={{
                  
                }} >

                    {/* At Doc Homoeo, we are dedicated to revolutionizing
                    healthcare by bridging the gap between patients and
                    homoeopathic medicine. Our mission is to provide convenient
                    access to high-quality homoeopathic medicines, expert
                    medical consultations, and unparalleled service to people
                    worldwide. */}
                  {" "}
                </p>
            ...
            <div className="col-12 col-lg-4">
              <div className="footer__section -payment">
                ...
                <p>
                Experience Hassle-Free Payments with Our Secure and Convenient Methods.
                </p>
